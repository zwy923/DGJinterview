...
class InterviewAssistantAgent:
    ...
    async def suggest_question(
        ...
        try:
            ...
            return await asyncio.wait_for(
                self._generate_suggestion(session_state, session_id, user_id),
    ...
    async def _generate_suggestion(
        ...
        recent_dialogue = "\n".join([
            ...
            for item in chat_history[-5:]  # 最近5条对话
        ])
        
        # 4. 构建prompt
        prompt_parts = [
            "你是一位专业的面试助手。根据以下信息，生成一个合适的面试问题。",
            "",
            "最近对话：",
            recent_dialogue,
        ]
        ...
        prompt_parts.extend([
            "",
            "请生成一个与当前对话上下文相关、有助于评估候选人能力的面试问题。",
            "问题应该：",
            "1. 与岗位要求相关",
            "2. 基于候选人背景",
            "3. 与当前对话连贯",
